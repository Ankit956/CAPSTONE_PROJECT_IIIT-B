## To get the details mentioned in the provider section, go to Azure CLI, and enter below command
    ## az ad sp create-for-rbac --name "terra" --role="Contributor" --scopes="/subscriptions/<subscriptions-ID>"
    ## The output will be in json format
    ## app_id = client_id; password = client_secret; tenant = tenant_id
    ## ** If the above command gives and error, give a new Service Provider name and try again
...
resource "local_file" "private_key" {
    ...
    filename = "/Users/Ankit Singh/Downloads/Capstone Notes/Task-1/azure-key.pem"
}
